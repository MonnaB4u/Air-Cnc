...
import './Payment.css'
import { faArrowTurnRight, faChevronRight, faCreditCard, faStarOfDavid } from '@fortawesome/free-solid-svg-icons'
        ...
        <div>
            <div className="flex-around">
                ...
                <div className="flex-center gap ml">
                    ...
                    <div className="travel-container card_container m-bt ">
                        <h3>Payment Selection</h3>

                        <div className="card_border ">
                            <div className="card_label card_padding">
                                ...
                                <div className="space-between ">
                                    ...
                                    <div className="c-card">
                                        <FontAwesomeIcon className="" icon={faCreditCard} />
                                        <FontAwesomeIcon className="cc" icon={faCreditCard} />
                                        <FontAwesomeIcon className="hicon" icon={faCreditCard} />
                                    </div>
                                </div>
                                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Labore, aperiam.
                                    Lorem ipsum, dolor sit amet consectetur adipisicing elit. Ratione, blanditiis.
                                </p>
                                <input className="ci" type="number" placeholder="0000 000 000 000" />

                                <div className="mt card-input-more">

                                    <div className="card_input_border">
                                        <label htmlFor="">NAME ON CARD</label>
                                        <input className="cii" type="text" />
                                    </div>

                                    <div className="card_input_border">
                                        <label htmlFor="">Expiry Data</label>
                                        <input className="cii "  type="date" />
                                    </div>
                    ...
                    <div className="travel-rules-form">
                        <div className="house-rules-card">
                            ...
                            <button className="card-btn bg">Reserve</button>
                        </div>
                    </div>
                </div>
            </div>
